      ...
      >
        <form id="register" method="post" onSubmit={credentialsSubmit}>
          ...
          <div className="register__box">
            <label htmlFor="user">
              User<i className="fas fa-asterisk"></i>
            </label>
            <input
              id="user"
              name="name"
              ...
              maxLength="64"
              required
              onChange={profileEditFunc}
              placeholder="Username"
            />
          </div>
          <div className="register__box">
            <label htmlFor="user">
              Address<i className="fas fa-asterisk"></i>
            </label>
            <input
              id="address"
              name="address"
          ...
          <div className="register__box">
            <label htmlFor="mail">
              E-mail<i className="fas fa-asterisk"></i>
            </label>
            <input
              id="mail"
              name="email"
          ...
          <div className="register__box">
            <label htmlFor="password">
              Phone<i className="fas fa-asterisk"></i>
            </label>
            <input
              id="phone"
              name="phone"
